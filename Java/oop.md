...
* 이러한 특징을 바탕으로 객체 지향 프로그래밍은 **잦은 요구사항 변경과 수정을 유연하게 수용**하고, **확장 가능한 설계가 가능**하다.
...
* 객체 지향 프로그래밍에서는 프로그램을 작성하는 절차도 중요시 여기지만, 주어진 데이터와 기능을 묶어 객체로 온전히 만드는 것에 더 중점을 둔다.
* 객체 지향 프로그래밍은 모든 사물을 속성과 기능을 가진 **객체**로 생각하는 것이다. 객체에는 **속성**과 **기능**만 존재한다.
